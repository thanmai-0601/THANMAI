...
describe('RequestPolicy', () => {
  let component: RequestPolicy;
  let fixture: ComponentFixture<RequestPolicy>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [RequestPolicy, HttpClientTestingModule, RouterTestingModule],
      providers: [
        ApiService,
    ...
    fixture = TestBed.createComponent(RequestPolicy);
